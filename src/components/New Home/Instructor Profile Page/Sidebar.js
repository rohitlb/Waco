...
export const Sidebar=(props)=>{
    return(
        <div className="pa2 white  flex flex-column items-center" style={{backgroundColor:"#3E2356",width:"300px"}}>
            ...
            <br/><br/>
            <Link to="/edusmith/Instructor-Profile" className="pa2 w-100 ma2 tl" style={{textDecoration:"none",color:"white"}}>

            <h5 className="tl" style={{fontFamily:"Overlock,Sans-serif",fontWeight:"500"}}
            >Profile Info</h5> 
            </Link>
            <Link to="/edusmith/Instructor-Profile/change-password" className="pa2 w-100 ma2 tl" style={{textDecoration:"none",color:"white"}}>

             <h5 className="tl" style={{fontFamily:"Overlock,Sans-serif",fontWeight:"500"}}
            >Change Password</h5>
            </Link>
            <Link to="/edusmith/Instructor-Profile/courses" className="pa2 w-100 ma2 tl" style={{textDecoration:"none",color:"white"}}>

            <h5 className="tl" style={{fontFamily:"Overlock,Sans-serif",fontWeight:"500"}}
                >Courses</h5>
            </Link>
            <Link to="/edusmith/Instructor-Profile/post-course" className="pa2 w-100 ma2 tl" style={{textDecoration:"none",color:"white"}}>
